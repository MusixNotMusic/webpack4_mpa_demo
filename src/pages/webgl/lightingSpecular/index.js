...
function main() {
    ...
    function radToDeg(r) {
      ...
      webglLessonsUI.setupSlider("#cameraX", {value: cameraX, slide: updateCameraX, min: -2000, max: 2000});
      webglLessonsUI.setupSlider("#cameraY", {value: cameraY, slide: updateCameraY, min: -2000, max: 2000});
      webglLessonsUI.setupSlider("#cameraZ", {value: cameraZ, slide: updateCameraZ, min: -2000, max: 2000});
      ...
      function drawScene() {
        ...
        var camera = [cameraX, cameraY, cameraZ]
        var target = [0, 35, 0]
        var up = [0, 1, 0]
